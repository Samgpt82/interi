        ...
        content: [
          {
            ...
            text: [
              ...
              `The user shops in ${market.country}. Use short useful names, ${market.priceGuidance}, accessible color hex values, and exactly three genuinely different swap suggestions.`,
              "For searchTerms, return one broad product category in the local language, using only 1 to 3 words (for example, 'soffa', 'soffbord' or 'taklampa'). Do not include colours, materials, dimensions, styles, country names, commas, or alternative searches; retailer search engines often return no results for over-specific phrases.",
