...
function RefinementSpinner() {
  ...
  return (
    <Animated.View testID="refinement-loading-spinner" style={animatedStyle}>
      <RefreshCw size={34} color={COLORS.white} />
    </Animated.View>
  );
}
